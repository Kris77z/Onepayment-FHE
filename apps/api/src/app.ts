...
import routes, { meRouter } from './routes/index.js';
...
// Auth routes (outside /api for compatibility with frontend)
import authRouter from './routes/auth.js';
app.use('/auth', authRouter);

// Merchant and user routes (require authentication in production)
app.use('/me', meRouter);
